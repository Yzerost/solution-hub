<template>
  <div class="top-nav">
    <div class="log">Solution Hub</div>
    <el-menu
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click" style="margin-top: 8px">
          <!--span class="el-dropdown-link userinfo-inner">
            <i class="iconfont icon-user" style="font-size: 30px"></i>  admin  <i class="el-icon-caret-bottom"></i></span-->
        <el-avatar style="background: #20a0ff">  admin </el-avatar>
